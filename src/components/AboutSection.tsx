    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative z-10">
      ...
      >
        ...
        <div className="bg-gray-900/80 px-4 py-2 border-b border-green-500/30 flex items-center gap-2">
          ...
          <span className="text-green-400 font-mono text-sm ml-4">about@portfolio:~$</span>
        </div>
        ...
        >
          ...
          <div className="text-green-400 mb-4">
            <div className="text-green-300">Welcome to Interactive About Section v1.0</div>
            <div className="text-green-500">Type 'whoami' to learn about me or 'help' to see available commands.</div>
          ...
          <form onSubmit={handleSubmit} className="flex items-center">
            <span className="text-gray-500 mr-2">user@about:~$ </span>
            <input
              ref={inputRef}
              type="text"
              value={input}
